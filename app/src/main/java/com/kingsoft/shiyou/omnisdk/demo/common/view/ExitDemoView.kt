...
class ExitDemoView : DemoView, IExitCallback {
    ...
    override fun initView() {
        ...
        findViewById<RadioButton>(R.id.exit_demo_view_custom_false).isChecked = true
        findViewById<RadioButton>(R.id.exit_demo_view_custom_true).isChecked = false
        gameCustom = false
        findViewById<RadioGroup>(R.id.exit_demo_view_custom_radio_group).setOnCheckedChangeListener { _, checkedId ->
            gameCustom = (checkedId == R.id.exit_demo_view_custom_true)
            DemoLogger.d(TAG, "set gameCustom: $gameCustom")
        }
        R.id.exit_demo_view_exit_btn.addClickListener {

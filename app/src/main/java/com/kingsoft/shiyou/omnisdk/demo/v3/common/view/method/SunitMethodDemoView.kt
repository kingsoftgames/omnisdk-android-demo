package com.kingsoft.shiyou.omnisdk.demo.v3.common.view.method
...
import com.kingsoft.shiyou.omnisdk.demo.v3.common.view.DemoView
import com.kingsoft.shiyou.omnisdk.demo.v3.common.view.EditTextDelegate
...
class SunitMethodDemoView : DemoView, IOtherCallback {
    ...
    override fun initView() {
        ...
        rewardedEt
        eventEt
        R.id.v3_sunit_method_demo_view_rewarded_btn.addClickListener {
            if (rewardedEt.checkContent()) {
                otherApi.invokeChannelSunitShowRewardedBadgeViewMethod(rewardedEt.content())
            }
        }
        R.id.v3_sunit_method_demo_view_event_btn.addClickListener {

...
import com.kingsoft.shiyou.omnisdk.demo.v3.common.utils.DemoResourceIdUtil
...
class OtherDemoView : DemoView, IOtherCallback {
    ...
    override fun initView() {
        ...
        R.id.v3_other_demo_view_action_dialog_btn.addClickListener {
            otherApi.doActionImpl()
        }

        R.id.v3_other_demo_view_oaid_dialog_btn.addClickListener {
            otherApi.getOAIdImpl()
        }

        R.id.v3_other_demo_view_emulator_dialog_btn.addClickListener {
            otherApi.checkEmulatorImpl()
        }
        R.id.v3_other_demo_view_settings_dialog_btn.addClickListener {
            otherApi.openAppPermissionSettingsImpl()
        }

        R.id.v3_other_demo_view_open_url_btn.addClickListener {
        ...
        R.id.v3_other_demo_view_open_local_url_btn.addClickListener {
            otherApi.openBrowserActivityWithLocalImpl()
        }

        initErrorTrackingDemoView()

        R.id.v3_other_demo_view_show_score_dialog_btn.addClickListener {
            otherApi.showScoreDialogImpl()
        }

        R.id.v3_pay_method_demo_view_query_inapp_skus_btn.addClickListener {
            val params = queryParamsEt.content()
            otherApi.invokeQuerySkuDetailsList(listOf(params), 0)
        }
        R.id.v3_pay_method_demo_view_query_subs_skus_btn.addClickListener {
            val params = queryParamsEt.content()
    ...
    private fun initErrorTrackingDemoView() {
        ...
        errorTrackMessageEt
        R.id.v3_other_demo_view_error_track_message_btn.addClickListener {
        ...
        R.id.v3_other_demo_view_error_track_custom_event_btn.addClickListener {
        ...
        R.id.v3_other_demo_view_error_track_divide_error_btn.addClickListener {
            val temp = 0
            try {
                val result = 100 / temp
            } catch (e: Exception) {
        ...
        R.id.v3_other_demo_view_error_track_out_of_index_error_btn.addClickListener {
        ...
        R.id.v3_other_demo_view_error_track_anr_error_btn.addClickListener {
            // 阻塞UI线程，模拟ANR异常
            runBlocking {
                delay(60_000)
            }
        ...
        R.id.v3_other_demo_view_error_track_crash_error_btn.addClickListener {
            // 抛出空指针异常，模拟应用奔溃CRASH
    ...
    private fun initChannelMethodDemoView() {
        channelMethodLayout = findViewById(R.id.v3_other_demo_view_channel_method_layout)
        var channelName = ConfigData.singletonInstance.channelName
        //兼容老项目上面的配置

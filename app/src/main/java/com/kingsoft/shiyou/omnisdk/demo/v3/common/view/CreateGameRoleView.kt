...
class CreateGameRoleView : DemoView {
    ...
    override fun initView() {
        loadTestDataTv = findViewById(R.id.v3_create_game_role_view_load_test_data_tv)
    ...
    var gameRoleInfo: RoleInfo
        ...
        set(inputRoleInfo) {
            uidEt = R.id.v3_create_game_role_view_uid_et.editText().apply {
                setText(inputRoleInfo.uid)
            }
            roleIdEt = R.id.v3_create_game_role_view_role_id_et.editText().apply {
                setText(inputRoleInfo.roleId)
            }
            roleNameEt = R.id.v3_create_game_role_view_role_name_et.editText().apply {
                setText(inputRoleInfo.roleName)
            }
            roleLevelEt = R.id.v3_create_game_role_view_role_level_et.editText().apply {
                setText(inputRoleInfo.roleLevel)
            }
            roleTypeEt = R.id.v3_create_game_role_view_role_type_et.editText().apply {
                setText(inputRoleInfo.roleType)
            }
            roleVipLevelEt = R.id.v3_create_game_role_view_role_vip_level_et.editText().apply {
                setText(inputRoleInfo.roleVipLevel)
            }
            roleFigureEt = R.id.v3_create_game_role_view_role_figure_et.editText().apply {
                setText(inputRoleInfo.roleFigure)
            }
            roleCreateTimeEt = R.id.v3_create_game_role_view_role_create_time_et.editText().apply {
                setText(inputRoleInfo.roleCreateTime)
            }
            serverIdEt = R.id.v3_create_game_role_view_server_id_et.editText().apply {
                setText(inputRoleInfo.serverId)
            }
            serverNameEt = R.id.v3_create_game_role_view_server_name_et.editText().apply {
                setText(inputRoleInfo.serverName)
            }
            zoneIdEt = R.id.v3_create_game_role_view_zone_id_et.editText().apply {
                setText(inputRoleInfo.zoneId)
            }
            zoneNameEt = R.id.v3_create_game_role_view_zone_name_et.editText().apply {
                setText(inputRoleInfo.zoneName)
            }
            accountAgeInGameEt =
                R.id.v3_create_game_role_view_account_age_in_game_et.editText().apply {
                    setText(inputRoleInfo.accountAgeInGame)
                }
            ageInGameEt = R.id.v3_create_game_role_view_age_in_game_et.editText().apply {
                setText(inputRoleInfo.ageInGame)
            }
            balanceEt = R.id.v3_create_game_role_view_balance_et.editText().apply {
                setText(inputRoleInfo.balance)
            }
            genderEt = R.id.v3_create_game_role_view_gender_et.editText().apply {
                setText(inputRoleInfo.gender)
            }
            partyNameEt = R.id.v3_create_game_role_view_party_name_et.editText().apply {
                setText(inputRoleInfo.partyName)
            }
            extEt = R.id.v3_create_game_role_view_ext_et.editText().apply {
